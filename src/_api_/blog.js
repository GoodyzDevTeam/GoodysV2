...
const POST_TITLES = [
  ...
  'Pairing Lockdowns Top Trends with Cannabis',
  'NFL Goat Calvin Johnson Lauches his own Cannabis Products',
  '✨What is Done is Done ✨',
  'How to Get High to Each 2021 "Album of the Year" Grammys Nominee',
  'Q&A with Gift of Doja Founder Nina Parks',
  'Your Guide to the Best Women-Owned Brands in Cannabis',
  'Your Top-Shelf Flower Shopping Guide',
  'What Is Delta-8-THC?',
  'The best new cannabis strains to grow 2021',
  'Your Monthly 2021 Cannabis Horoscope',
  'Explore Black voices in cannabis',
  'How to spot a fake vape cartridge',
  'SF Roots | Cannabis, Compassion, Community',
  '14 Ways to Enjoy Your Valentines Day to the Highest Degree',
  'Actress and Rapper Bre-Z Pivots Towards Cannabis WIth Cann',
  'Q&A with New Life Founder Carlton Williams',

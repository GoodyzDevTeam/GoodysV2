...
const AppRoutes = {
  ...
  routes: [
    ...
    },
    {
      ...
      component: lazy(() => import('src/views/e-commerce/DiscoverPage'))
    ...
    {
      exact: true,
      path: PATH_APP.management.eCommerce.discover,
      component: lazy(() => import('src/views/e-commerce/DiscoverPage'))
    },
    {
      exact: true,
    ...
    {
      exact: true,
      path: PATH_APP.management.blog.learn,
      component: lazy(() => import('src/views/blog/Learn'))
    },
    {
      exact: true,
